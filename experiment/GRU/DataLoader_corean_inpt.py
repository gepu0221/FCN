...
class DataLoader_c():
    def __init__(self, im_size, nbr_frames, mask_path, im_path):
        '''
        Args:
        ...
        self.L = glob.glob(os.path.join(self.mask_path, '*inst_mask.bmp'))
    ...
    def get_next_sequence(self):
        ...
        fn = os.path.splitext(im_path.split("/")[-1])[0].split('_inst_mask')[0]
        parts = fn.split('img')
        ...
        return images, pad_images, mask, fn
