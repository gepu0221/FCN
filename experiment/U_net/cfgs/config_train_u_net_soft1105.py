...
#1.2 Label path
#Remove occulded area origin soft labels  .
cfgs.anno_path = '/home/gp/repos/FCN/experiment/finetune_label/s8_ori1_noOccu_soft20_1105'


cfgs.data_pickle_fn = "data_ori_soft20_noOccu_1105.pickle"
#cfgs.data_pickle_fn = "data_ori_soft_noOccu_1105.pickle"

#1.3 Logs path
#cfgs.logs_dir = 'logs/logs_s8_ori_soft20_noOcculde_1105/'
cfgs.logs_dir = 'logs/logs_s8_ori_soft20_noOcculde_1105/'
...
cfgs.view_path = 'view/s8_ori_soft20_noOccu_1105'
...
cfgs.test_accu = False
cfgs.test_view = False
cfgs.if_train = True
