...
def read_txt_data(folder_dir, anno_folder):
    ...
    for txt_file in cfgs.file_list:
        ...
        while True:
            ...
            anno_frame = '/home/gp/repos/FCN/experiment/finetune_label/s8_ori1_noOccu_1030/s8img00000.bmp'
            ...
            if True:
                ...
                record = {'current':cur_frame, 'seq':seq_set, 'annotation':anno_frame, 'ellip_info':ellip_info, 'label':label, 'filename':filename}
                print(record)
