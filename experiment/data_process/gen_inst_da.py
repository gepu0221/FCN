...
inst_da_mask_dir = 'data/inst_da/rect_inst_da_mask'

save_dir = 'data/inst_da/rect_inst_da1214'
save_mask_dir = 'data/inst_da/rect_inst_da_mask1214'
...
for f in file_list:
    ...
    inpt_mask[i0:i1, j0:j1, :] = mask * 255
