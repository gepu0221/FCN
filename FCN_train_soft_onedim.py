...
tf.flags.DEFINE_integer("temperature", "2", "The temperature use to train soft targets model")
#THe path to save train model.
tf.flags.DEFINE_string("logs_dir", "logs20180527_soft_onedim/", "path to logs directory")
...
tf.flags.DEFINE_string("data_dir", "image_save20180527_soft_onedim", "path to dataset")
#the learning rate
...
def main(argv=None):
    ...
    loss = tf.reduce_mean((tf.nn.sigmoid_cross_entropy_with_logits(logits=soft_logits[:,:,:,1],
